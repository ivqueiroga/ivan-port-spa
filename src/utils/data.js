...
const data = {
  icons :[
    ...
    {name: 'Photoshop', icon: SiAdobephotoshop, text: 'Photoshop é um software de edição de imagens, amplamente utilizado na indústria criativa, que permite a manipulação, correção, criação e aprimoramento de fotos e elementos gráficos de forma profissional.'},
