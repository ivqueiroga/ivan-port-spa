  ...
  return (
    <div className='about-container' id='about'>
      ...
      <div className='p-container left'>
        ...
        <p className='p2-text'>Como desenvolvedor web, com a biblioteca React, crio UI`s fluidas atreladas ao Redux para gerenciamento global de estado.Páginas responsivas, Single Page Application, Mobile First, Metodologias Ágeis estão dentro da minha zona de conforto.</p>
      </div>
      <div className='p-container right'>
